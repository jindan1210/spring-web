...
public class HttpClientUtil implements HttpClientWrapper {
    ...
    public HttpClientUtil() {
        super();
//		Protocol myhttps = new Protocol("https", new SProtocolSocketFactory(), 443);
//		Protocol.registerProtocol("https", myhttps);
    ...
    public void doRequest(HttpResponseCallBack callback, MethodType method,
                          String url, Map<String, String> params, String charset) throws HttpException, IOException {
        ...
        try {
            ...
            this.client.getHttpConnectionManager().closeIdleConnections(0);//定期关闭空闲连接
            if (httpMethod != null) {
